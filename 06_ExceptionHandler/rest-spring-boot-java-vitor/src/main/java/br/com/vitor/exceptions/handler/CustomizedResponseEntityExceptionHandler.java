package br.com.vitor.exceptions.handler;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public final ResponseEntity<ExceptionResponse> handleBadRequestExceptions(
		...
		// Retorna uma response com um status code de BAD_REQUEST (podemos usar qualquer status code, pra saber qual assista a parte teórica sobre eles)
